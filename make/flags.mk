...
PROGRAM_CFLAGS := $(COMMON_INCLUDE_FLAGS)
PROGRAM_DEPFLAGS :=
ifeq ($(BUILD_TOOLCHAIN),clang)
PROGRAM_CFLAGS := $(CLANG_LANGUAGE_FLAGS) $(COMMON_INCLUDE_FLAGS) $(ARCH_FLAGS)
PROGRAM_DEPFLAGS := -MMD -MP
endif
HOST_CFLAGS := $(CLANG_LANGUAGE_FLAGS) $(COMMON_INCLUDE_FLAGS) $(ARCH_FLAGS)
