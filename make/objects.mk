...
SHARED_LIBS := $(KIT_WORKSPACE_AUTHORING_LIB) $(KIT_UI_LIB) $(KIT_PANE_LIB) $(KIT_RENDER_LIB) $(CORE_PACK_LIB) $(CORE_PANE_LIB) $(CORE_LAYOUT_LIB) $(CORE_PANE_MODULE_LIB) $(CORE_THEME_LIB) $(CORE_FONT_LIB) $(CORE_VIEWPORT2D_LIB) $(CORE_AUTHORED_TEXTURE_LIB) $(CORE_SCENE_LIB) $(CORE_OBJECT_LIB) $(CORE_UNITS_LIB) $(CORE_BASE_LIB)
